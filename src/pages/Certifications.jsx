  ...
  return (
    ...
    >
      ...
      {certificates.map((certificate, index) => (
        <div
          className="flex items-center gap-4 bg-gray-50 px-4 min-h-14 mt-10"
          key={index}
        >
          <div
            className="text-[#101518] flex items-center justify-center rounded-lg bg-[#eaedf1] shrink-0 size-10"
          ...
          <div className="flex justify-between items-center w-full">
            <div className="flex flex-col gap-1 ">
              <p className="text-[#101518] text-base font-normal  flex-1 ">
                {certificate.title}
              </p>
